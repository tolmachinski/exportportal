...
<script>
    ...
    $(document).ready(function(){
        dataT = dtFeedbacksList = $('#dt-feedbacks-list').dataTable( {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo __SITE_URL; ?>feedbacks/ajax_my_list_dt",
            "sServerMethod": "POST",
            "aoColumnDefs": [
...
<div class="container-center dashboard-container">
    ...
    <div class="dashboard-line">
        <h1 class="dashboard-line__ttl">Received feedback</h1>

        <div class="dashboard-line__actions">
            <!-- <a class="btn btn-light fancybox fancybox.ajax" href="<?php echo __SITE_URL;?>user_guide/popup_forms/show_doc/feedbacks_received_doc?user_type=<?php echo strtolower(user_group_type());?>" title="Received feedback" data-title="Received feedback" target="_blank">User guide</a> -->
    ...
    <div class="info-alert-b">
		...
		<span><?php echo translate('feedbacks_my_description'); ?></span>
	</div>
