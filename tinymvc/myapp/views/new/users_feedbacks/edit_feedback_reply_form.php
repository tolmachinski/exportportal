<?php if(logged_in()){?>
	<div class="js-modal-flex wr-modal-flex inputs-40">
		<form
            ...
            data-callback="usersFeedbacksEditReplyFormCallBack"
        >
			<div class="modal-flex__content mh-300">
				...
				<textarea
                    ...
                    <?php echo addQaUniqueIdentifier('popup__edit-feedback-reply__form_description-textarea') ?>
                ><?php echo $feedback['reply_text'];?></textarea>
			...
			<div class="modal-flex__btns">
                <div class="modal-flex__btns-right">
                    <button
                        ...
                        type="submit"
                        <?php echo addQaUniqueIdentifier('popup__edit-feedback-reply__form_save-btn') ?>
                    ><?php echo translate('edit_feedback_reply_form_submit_btn');?></button>
                </div>
			</div>
		</form>
	</div>
	<script>
		...
		function usersFeedbacksEditReplyFormCallBack(form){
			var $form = $(form);
			...
			$.ajax({
				...
				success: function(resp){
					...
					if(resp.mess_type == 'success'){
						callFunction('editReplyFeedbackCallback', resp);
						closeFancyBox();
					}else{
