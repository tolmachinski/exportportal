<div class="container-fluid-modal">
    ...
    <div class="row">
        <div class="col-12 col-lg-6">
            <label class="input-label text-nowrap">Highlight number</label>
            <input class="dt_filter" type="text" data-title="Highlight number" placeholder="Highlight number" name="highlight_number" value="<?php if(isset($id_highlight)) echo orderNumber($id_highlight);?>">
        </div>
        ...
        <div class="col-12 col-lg-6">
            ...
            <select class="dt_filter" data-title="Status" level="1" name="status">
