<div class="js-modal-flex wr-modal-flex inputs-40">
    <form
        id="edit-comment-reply--form"
        class="modal-flex__form validateModal"
        data-callback="itemsCommentsEditReplyFormCallBack"
    ...
    >
        ...
        <div class="modal-flex__btns">
            <div class="modal-flex__btns-right">
                <button class="btn btn-primary" type="submit" id="edit-comment-reply--formaction--submit">
...
<script>
    $(function(){
        var onSaveContent = function(formElement) {
            ...
            var onRequestSuccess = function(data){
                ...
                if(data.mess_type === 'success'){
                    ...
                    callFunction('editCommentReplyCallback', data);
                }
            };
        ...
        var form = $('#edit-comment-reply--form');
        ...
        mix(globalThis, { itemsCommentsEditReplyFormCallBack: onSaveContent }, false);
    });
</script>
