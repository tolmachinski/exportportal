            ...
            <div class="uinfo-complete__list-item <?php echo $isCompleted ? ' uinfo-complete__list-item--completed' : ''; ?>" <?php echo addQaUniqueIdentifier('ff-complete-profile__' . str_replace('_', '-', $profile_completion_option['option_alias']));?>>
                <a href="<?php echo __SITE_URL . $profile_completion_option['option_url']; ?>">
                    <div class="uinfo-complete__list-img">
                        <?php $imgPath =  $is_dashboard ? "public/build/images/profile_completion/" : "public/build/images/popups/profile_completion/"; ?>
                        <img class="image" src="<?php echo asset($imgPath . $profile_completion_option['option_image'] . ".jpg"); ?>" alt="<?php echo translate("translate_profile_option_alt_{$profile_completion_option['option_alias']}", null, true); ?>">
