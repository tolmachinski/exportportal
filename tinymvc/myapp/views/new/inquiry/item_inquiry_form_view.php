<div class="js-modal-flex wr-modal-flex inputs-40">
	<form
        id="js-item-inquiry-form"
        class="modal-flex__form validateModal"
        data-callback="inquiryFormCallBack"
    >
		<div id="js-modal-inquiry-content" class="modal-flex__content">
            ...
            <div class="form-group">
                ...
                <textarea class="validate[required,maxSize[1000]] js-input-textcounter" name="changes" placeholder="Enter the changes" data-max="1000"></textarea>
            </div>

            <div class="form-group">
                <label class="input-label">Comment</label>
                <textarea class="validate[maxSize[1000]] js-input-textcounter" name="comment" placeholder="Enter the comment" data-max="1000"></textarea>
            </div>
	...
	<div class="modal-flex__wr-actions" style="display: none">
		<div class="modal-flex__actions">
			<div class="ep-medium-text mb-15">
				<p>
					The "Send inquiry" request has been successfully sent. You may discuss about this Inquiry with the seller by clicking "Go to inquiry" button or you can continue shopping.
				</p>
			</div>

			<a class="btn btn-primary call-function" data-callback="closeFancyBox">Continue shopping</a>
			<a class="btn btn-primary" href="<?php echo __SITE_URL . 'inquiry/my';?>">Go to inquiry</a>
		</div>
	</div>
</div>
...
<script>
	$(function(){
		var form = $('#js-item-inquiry-form');
		var onSaveContent = function (formElement) {
			var url = __site_url + 'inquiry/ajax_inquiry_operation/create_inquiry';
			...
			var onRequestSuccess = function(data){
				if (data.mess_type == 'success') {
                    ...
                    open_result_modal({
                        ...
                        buttons: [
							{
                                label: translate_js({ plug: "general_i18n", text: "js_bootstrap_dialog_view_inquiry" }),
                                cssClass: "btn btn-primary",
                                action: function (dialog) {
                                    location.href = __site_url + "inquiry/my";
                                },
                            },
                            {
		...
		var getQuantityForInquiry = function (form) {
        ...
        mix(window, { inquiryFormCallBack: onSaveContent }, false);
	});
</script>
