<?php tmvc::instance()->controller->view->display('new/filter_panel_main_view', array('filter_panel' => 'new/user/seller/videos/categories/filter_panel_view')); ?>

<div class="container-center dashboard-container">

    <div class="dashboard-line">
        <h1 class="dashboard-line__ttl"><?php echo translate("seller_videos_categories_dashboard_title_text"); ?></h1>

        <div class="dashboard-line__actions">
            <a class="btn btn-primary pl-20 pr-20 fancybox.ajax fancyboxValidateModal"
                <?php echo addQaUniqueIdentifier("seller-videos-categories__dashboard_add-category-btn")?>
                data-fancybox-href="<?php echo __SITE_URL;?>seller_videos/popup_forms/add_category"
            ...
            <a class="btn btn-light"
                <?php echo addQaUniqueIdentifier("seller-videos-categories__dashboard_videos-btn")?>
                href="<?php echo __SITE_URL;?>seller_videos/my"
                title="<?php echo translate("seller_videos_categories_dashboard_videos_button_title", null, true); ?>">
                <?php echo translate("seller_videos_categories_dashboard_videos_button_text"); ?>
            </a>

            <a class="btn btn-dark btn-filter fancybox btn-counter"
                <?php echo addQaUniqueIdentifier("seller-videos-categories__dashboard_filter-btn")?>
    ...
    <table class="main-data-table" id="dtCategoriesList">
        <thead>
            <tr>
                <th class="category_dt"><?php echo translate("seller_videos_categories_dashboard_dt_column_category_text"); ?></th>
                <th class="created_dt"><?php echo translate("seller_videos_categories_dashboard_dt_column_create_date_text"); ?></th>
                <th class="updated_dt"><?php echo translate("seller_videos_categories_dashboard_dt_column_update_date_text"); ?></th>
...
<script type="application/javascript">
    $(function() {
        ...
        var deleteCategory = function(caller) {
            ...
            var url = __site_url + 'seller_videos/ajax_videos_operation/delete_category';
        ...
        var datagridOptions = {
            ...
            bProcessing: false,
            bServerSide: true,
            sAjaxSource: location.origin + '/seller_videos/ajax_videos_categories_dt',
            aoColumnDefs: [
        ...
        mix(window, {
            ...
            callbackAddVideosCategory: onAddCategory,
            callbackEditVideosCategory: onEditCategory,
        });
    });
</script>
