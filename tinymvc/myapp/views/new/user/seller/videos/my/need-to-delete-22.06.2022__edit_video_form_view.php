    ...
    <form class="modal-flex__form validateModal" action="<?php echo $action; ?>">
                        ...
                        <?php if (!empty($videos_categories)) { ?>
                            <?php foreach ($videos_categories as $video_category) { ?>
                                <option value="<?php echo $video_category['id_category']; ?>"
                                    <?php echo selected($video['id_category'], $video_category['id_category'])?>>
                ...
                <ul class="list-form-checked-info">
                    <li class="list-form-checked-info__item">
                        <label class="list-form-checked-info__label mb-0">
                            <input id="js-edit-video-post-wall" name="post_wall" type="checkbox">
        ...
        <div class="modal-flex__btns">
            <div class="modal-flex__btns-right">
                <button class="btn btn-primary" type="submit" id="edit-video--formaction--submit"><?php echo translate('general_modal_button_save_text'); ?></button>
            </div>
        </div>
    </form>
</div>
...
<script type="application/javascript">
    ...
    $(function() {
        ...
        var postWall = $('#js-edit-video-post-wall');
        var description = $('#js-edit-video-description');
        var postWallOptions = {
