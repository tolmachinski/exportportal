<div class="js-wr-modal wr-modal-flex inputs-40">
    <form
        ...
        data-callback="sellerPicturesPopupShareFormCallBack"
    ...
    >
        <div class="modal-flex__content">
            <div class="form-group">
                ...
                <textarea
                    name="message"
                    <?php echo addQaUniqueIdentifier('popup__share-picture__form_message-textarea'); ?>
                    id="js-share-picture-mail-message"
        ...
        <div class="modal-flex__btns">
            <div class="modal-flex__btns-right">
                <button class="btn btn-primary" type="submit" <?php echo addQaUniqueIdentifier('popup__seller-pictures__share-form_send-btn'); ?>>
...
<script type="application/javascript">
    $(function(){
        var onSaveContent = function(formElement) {
            ...
            var onRequestSuccess = function(data){
                ...
                if(data.mess_type === 'success'){
                    closeFancyBox();
                    callFunction('callbackSharePicture', data);
                }
            };
        ...
        var mailMessage = $('#js-share-picture-mail-message');
        var counterOptions = {
            countDown: true,
        ...
        window.sellerPicturesPopupShareFormCallBack = onSaveContent;
    });
</script>
