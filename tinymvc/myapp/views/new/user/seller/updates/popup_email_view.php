<div class="js-wr-modal wr-modal-flex inputs-40">
    <form
        ...
        data-callback="sellerUpdatesPopupEmailFormCallBack"
        ...
        <div class="modal-flex__content">
            <div class="form-group">
                ...
                <input type="text"
                    ...
                    <?php echo addQaUniqueIdentifier('popup__company-updates__email-form_emails-input'); ?>
                />
            ...
            <div class="form-group">
                ...
                <textarea name="message"
                    ...
                    <?php echo addQaUniqueIdentifier('popup__company-updates__email-form_message-textarea'); ?>></textarea>
            </div>
        ...
        <div class="modal-flex__btns">
            <div class="modal-flex__btns-right">
                <button
                    ...
                    type="submit"
                    <?php echo addQaUniqueIdentifier('popup__company-updates__email-form_send-btn'); ?>
                >
...
<script type="application/javascript">
    $(function(){
        ...
        window.sellerUpdatesPopupEmailFormCallBack = onSaveContent;
    });
</script>
