<div class="container-fluid-modal">
    ...
    <input type="text"
        ...
        maxlength="50"
        <?php echo addQaUniqueIdentifier('seller-updates-my__filter-panel_keywords-input_popup'); ?>
    >
    ...
    <div class="row">
        <div class="col-12 col-lg-6 mb-15-sm-max">
            <input type="text"
                ...
                readonly
                <?php echo addQaUniqueIdentifier('seller-updates-my__filter-panel_created-from-input_popup'); ?>
            >
        </div>
        <div class="col-12 col-lg-6">
            <input type="text"
                ...
                readonly
                <?php echo addQaUniqueIdentifier('seller-updates-my__filter-panel_created-to-input_popup'); ?>
            >
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-6 mb-15-sm-max">
            <input type="text"
                ...
                readonly
                <?php echo addQaUniqueIdentifier('seller-updates-my__filter-panel_updated-from-input_popup'); ?>
            >
        </div>
        <div class="col-12 col-lg-6">
            <input type="text"
                ...
                readonly
                <?php echo addQaUniqueIdentifier('seller-updates-my__filter-panel_updated-to-input_popup'); ?>
            >
        </div>
    </div>
</div>
