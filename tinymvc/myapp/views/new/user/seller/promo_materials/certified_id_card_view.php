<style>
    ...
    .main-wrapper {
        ...
        font-family: Roboto, sans-serif;
        color: #ffffff;
        background-image: url(<?php echo asset('public/build/images/promo_materials/certified/cert-bg-front.png'); ?>);
    ...
    .id-card__photo {
        width: 432px;
        height: 432px;
        background-image: url(<?php echo checked(1, session()->__get('user_photo_with_badge')) ? getUserAvatar($user['idu'], "badge_" . $user['user_photo'], $user['user_group']) : getUserAvatar($user['idu'], $user['user_photo'], $user['user_group']); ?>);
    ...
    .id-card__logo {
        ...
        border-radius: 50%;
        margin-top: -182px;
        background-image: url(<?php echo asset("public/build/images/promo_materials/certified/cert-user-logo.png"); ?>);
        background-position: center center;
        background-size: cover;
    }
...
<div class="cards-wrapper" style="height: 1162px">
    <div style="box-sizing: border-box; width: 789px; float:left;">
        <div class="main-wrapper">
            <div class="id-card">
                ...
                <div class="id-card__company">
                    Official of: <?php echo $company['name_company']; ?>
                </div>

                <div class="id-card__status id-card__status--certified">
