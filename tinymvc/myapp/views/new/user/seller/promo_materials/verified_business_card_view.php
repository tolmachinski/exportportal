...
<div class="cards-wrapper" style="height: 596px; margin: 0px auto; ">
    <div style="width: 1050px; float:left;">
        <div class="main-wrapper" style="max-width: 1050px; width: 1050px; height: 596px; margin: 0 auto 0 auto; font-family: Roboto, sans-serif; background-image: url(<?php echo asset('public/build/images/promo_materials/verified/verif-card-front.png'); ?>); background-repeat: no-repeat; background-size: 53%; background-position: 100% 1px;  background-color: #00244E;">
        <div style="padding: 57px 58px 37px 58px; ">
            <div style="height: 300px; width: 250px; margin-left: 124px;">
                ...
                <div style="height: 100px; width: 100px;  background-image: url(<?php echo asset("public/build/images/promo_materials/verified/verif-user-logo.png"); ?>); background-size: cover; border-radius: 50%; margin: -53px auto; position:relative; z-index: 1;" ></div>
            </div>
            <table style="width: 100%; color: #ffffff;  font-family: Roboto; padding-left: 37px;" border="0" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td style="width: 424px; height: 126px; font-size: 44px; font-weight: 500; vertical-align: bottom; padding-top: 20px; text-align:center;" colspan="1"><?php echo strtoupper($company['name_company']);?></td>

                    </tr>
                    <tr>
                        <td style="height: 34px; font-size: 30px;  vertical-align: top; padding-top: 18px; color: #00BE53; text-align:center;" colspan="1"><?php echo $user['gr_name'];?></td>
    ...
    <div class="main-wrapper" style="max-width: 1050px; width: 1050px; height: 600px; margin: 0 auto 0 auto; font-family: Roboto, sans-serif; background-image: url(<?php echo asset('public/build/images/promo_materials/verified/verif-card-back.png'); ?>); background-repeat: no-repeat; background-size: contain; background-position: right bottom;  background-color: #ffffff;">
