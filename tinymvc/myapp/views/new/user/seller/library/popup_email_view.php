<div class="js-wr-modal wr-modal-flex inputs-40">
    <form
        ...
        data-callback="sellerLibraryPopupEmailFormCallBack"
        action="<?php echo $action; ?>"
        <?php echo addQaUniqueIdentifier('popup__seller-library-email__form'); ?>
    >
        <div class="modal-flex__content">
            <div class="form-group">
                ...
                <input type="text"
                    ...
                    <?php echo addQaUniqueIdentifier('popup__seller-library-email__form_email-input'); ?>
                />
            ...
            <div class="form-group">
                ...
                <textarea name="message"
                    id="js-mail-document-mail-message"
                    ...
                    <?php echo addQaUniqueIdentifier('popup__seller-library-email__form_message-textarea'); ?>
                ></textarea>
            </div>
        ...
        <div class="modal-flex__btns">
            <div class="modal-flex__btns-right">
                <button
                    ...
                    type="submit"
                    <?php echo addQaUniqueIdentifier('popup__seller-library-email__form_submit-btn'); ?>
                >
...
<script type="application/javascript">
    $(function(){
        var onSaveContent = function(formElement) {
            ...
            var onRequestSuccess = function(data){
                ...
                if(data.mess_type === 'success'){
                    closeFancyBox();
                    callFunction('callbackMailLibraryDocument', data);
                }
            };
        ...
        var mailMessage = $('#js-mail-document-mail-message');
        var counterOptions = {
            countDown: true,
        ...
        window.sellerLibraryPopupEmailFormCallBack = onSaveContent;
    });
</script>
