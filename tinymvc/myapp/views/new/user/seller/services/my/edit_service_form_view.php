<div class="js-modal-flex wr-modal-flex inputs-40">
    <form
        ...
        data-callback="sellerServicesMyEditServiceFormCallBack"
        action="<?php echo $action; ?>"
    >
        <input type="hidden" name="info" value="<?php echo $service; ?>"/>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text"
                            maxlength="50"
                            name="title"
                            id="edit-service--formfield--name"
                            class="validate[required,maxSize[50]]"
                            value="<?php echo cleanOutput($service_info['title_service']); ?>"
                    ...
                    <div class="col-12 col-md-6 wr-select2-h50">
                        ...
                        <select name="phone_code" class="form-control validate[required]" id="edit-service--formfield--phone-codes">
                            <option></option>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text"
                            maxlength="60"
                            name="phone"
                            id="edit-service--formfield--phone"
                            class="validate[required,custom[phoneNumber],maxSize[60]]"
                            value="<?php echo cleanOutput($service_info['phone_service']); ?>"
                    ...
                    <div class="col-12">
                        ...
                        <input type="text"
                            maxlength="100"
                            name="email"
                            id="edit-service--formfield--email"
                            class="validate[required,custom[noWhitespaces],custom[emailWithWhitespaces],maxSize[100]]"
                            value="<?php echo cleanOutput($service_info['email_service']); ?>"
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="text"
                            id="edit-service--formfield--description"
                            class="validate[required,maxSize[500]] h-80 textcounter"
                            data-max="500"
                            placeholder="<?php echo translate('company_services_dashboard_modal_field_description_placeholder_text', null, true); ?>"
                        ><?php echo cleanOutput($service_info['info_service']); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal-flex__btns">
            <div class="modal-flex__btns-right">
                <button class="btn btn-primary" type="submit" id="edit-service--formaction--submit">
...
<script type="application/javascript">
    $(function() {
        ...
        var onSaveContent = function(formElement) {
            ...
            var onRequestSuccess = function(data){
                ...
                if(data.mess_type === 'success'){
                    closeFancyBox();
                    callFunction('callbackEditServiceBlock', data);
                }
            };
        ...
        var description = $('#edit-service--formfield--description');
        var phoneCodes = $('#edit-service--formfield--phone-codes');
        var counterOptions = {
            countDown: true,
        ...
        if(phoneCodes.length) {
            ...
            phoneCodes.select2(phoneCodesOptions)
                .data('select2')
                .$container
                    .attr('id', 'edit-service--formfield--tags-container')
                    .addClass('validate[required]')
                    .setValHookType('select2');
        }

        window.sellerServicesMyEditServiceFormCallBack = onSaveContent;
    });
</script>
