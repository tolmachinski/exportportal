		...
		<table cellspacing="0" cellpadding="0" class="data table-striped table-bordered w-100pr vam-table">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="title" class="validate[required] w-100pr" placeholder="Standard title" value="" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<textarea class="w-100pr h-50 validate[required] tinymce" name="description"></textarea>
					</td>
				</tr>
			</tbody>
		</table>
...
function modalFormCallBack(form, data_table){
	...
	$.ajax({
		type: 'POST',
		url: '<?php echo __SITE_URL ?>international_standards/ajax_operations/add_standard',
		data: $form.serialize(),
		beforeSend: function () {
			showLoader($form);
		},
