				...
				<tr>
					...
					<td>
						<span class="btn btn-success fileinput-button">
							...
							<input id="add_fileupload" type="file" name="files[]" multiple  accept="<?php echo $accept; ?>">
						</span>
						...
						<div class="info-alert-b mt-10">
							...
							<div> &bull; File available formats (jpg,jpeg).</div>
						</div>
						...
						<?php if(isset($ep_news['main_image']) && !empty($ep_news['main_image'])){?>
							<div class="uploadify-queue-item item-large">
								<div class="img-b">
									<img src="<?php echo $ep_news['imageUrl']?>" />
								</div>
...
$(document).ready(function(){
	...
	var imageFormats = new RegExp('(.|\/)(<?php echo $formats; ?>)', 'i');
	var fileTypes = new RegExp('(<?php echo $mimetypes; ?>)', 'i');
