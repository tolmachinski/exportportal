			...
			<tr>
				...
				<td>
					<div class="input-group input-group--checks">
						<label class="input-group-addon" title="Show all questions">
						...
						<label class="input-group-addon" title="Show questions which are not moderated">
							<input class="dt_filter" type="radio" name="moderated" data-title="Status" data-value-text="new" value="new">
							<span class="input-group__desc">New</span>
						</label>
						<label class="input-group-addon" title="Show questions which are moderated">
							<input class="dt_filter" type="radio" name="moderated" data-title="Status" data-value-text="moderated" value="moderated">
			...
			<tr>
				...
				<td>
					<div class="input-group input-group--checks">
						...
						<label class="input-group-addon" title="Show not replied questions">
							<input class="dt_filter" type="radio" name="replied" data-title="Replied" data-value-text="no" value="no">
							<i class="ep-icon ep-icon_questions txt-blue input-group__desc"></i>
						</label>
						<label class="input-group-addon" title="Show replied questions">
