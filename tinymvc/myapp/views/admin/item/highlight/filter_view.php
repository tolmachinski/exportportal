    ...
    <div class="filter-admin-panel">
        ...
        <table>
            ...
            <tr>
                <td>Status</td>
                <td>
                    <select class="dt_filter" data-title="Highlight status" level="1" name="ith_status">
			...
			<tr>
				...
				<td>
					<div class="input-group">
						<input class="form-control dt_filter start_from" type="text" data-title="Add date from" name="start_from" id="start_from" placeholder="From" readonly>
						<div class="input-group-addon">-</div>
						<input class="form-control dt_filter start_to" type="text" data-title="Add date to" name="start_to" id="start_to" placeholder="To" readonly>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class="input-group">
						<input class="form-control dt_filter end_from" type="text" data-title="Add date from" name="end_from" id="end_from" placeholder="From" readonly>
						<div class="input-group-addon">-</div>
						<input class="form-control dt_filter end_to" type="text" data-title="Add date to" name="end_to" id="end_to" placeholder="To" readonly>
					</div>
				</td>
			</tr>
        </table>
