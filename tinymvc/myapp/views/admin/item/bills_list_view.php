...
<div class="wr-form-content w-700">
    <ul class="bills-list-b">
        ...
        <li id="bill-<?php echo $item['id_bill'];?>-block" class="relative-b">
            <div class="clearfix">
            <?php if($item['name_type'] == 'feature_item'){?>
                <p class="type-b">Feature item bill</p>
            <?php }?>
            <?php if($item['name_type'] == 'highlight_item'){?>
                <p class="type-b">Highlight item bill</p>
            <?php }?>
            ...
            <div class="row">
                <div class="col-xs-3 pr-0 mt-5">
                    <strong class="total-amount-b txt-blue lh-30">
                        ...
                        <?php $balance_total += $item['balance'];?>
                    </strong>
                </div>
            ...
            <div class="clearfix">
                ...
                <?php }?>
                <?php if($item['amount'] > $item['balance']){?>
                    <?php if(!$item['refund_bill_request']){?>
                        <a class="btn btn-danger fancybox.ajax fancyboxValidateModal btn-xs pull-right mt-5 mr-5" href="<?php echo __SITE_URL;?>external_bills/popup_forms/refund_form/<?php echo $item['id_bill'];?>?return_to=<?php echo $return_to_modal_url;?>" data-title="Refund the user" title="Refund the user"><i class="ep-icon ep-icon_dollar-circle"></i> Refund the user</a>
                    <?php } else{?>
                        <a class="btn btn-default btn-xs pull-right mt-5 mr-5 fancybox.ajax fancyboxValidateModal" href="<?php echo __SITE_URL;?>external_bills/popup_forms/notice/<?php echo $item['refund_bill_request'];?>?return_to=<?php echo $return_to_modal_url;?>" data-title="Notes"><i class="ep-icon ep-icon_notice"></i> Refund detail</a>
                    <?php }?>
                <?php }?>
            </div>
            ...
            <div class="additional-desc ml-0" id="bill-detai-<?php echo $item['id_bill'];?>" style="display:none;">
                ...
                <table class="data table-striped mt-15 w-100pr">
                    <caption><i class="ep-icon ep-icon_dollar-circle"></i> <strong>Payment details</strong></caption>
                    <thead>
                        <tr>
