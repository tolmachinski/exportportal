<div class="wr-form-content w-700">
    <ul class="bills-list-b">
        ...
        <li id="bill-<?php echo $item['id_bill'];?>-block" class="relative-b">
            <div class="clearfix">
                <p class="type-b"><?php echo $item['show_name'];?></p>
            ...
            <div class="clearfix">
                ...
                <?php if($item['status'] == 'confirmed'){?>
                    <?php if(!$item['refund_bill_request']){?>
                        <a class="btn btn-danger fancybox.ajax fancyboxValidateModal btn-xs pull-right mt-5 ml-5" href="<?php echo __SITE_URL;?>external_bills/popup_forms/refund_form/<?php echo $item['id_bill'];?>?return_to=<?php echo $return_to_modal_url;?>" data-title="Refund the user" title="Refund the user"><i class="ep-icon ep-icon_dollar-circle"></i> Refund the user</a>
                    <?php } else{?>
                        <a class="btn btn-default btn-xs pull-right mt-5 ml-5 fancybox.ajax fancyboxValidateModal" href="<?php echo __SITE_URL;?>external_bills/popup_forms/notice/<?php echo $item['refund_bill_request'];?>?return_to=<?php echo $return_to_modal_url;?>" data-title="Notes"><i class="ep-icon ep-icon_notice"></i> Refund detail</a>
                    <?php }?>
                <?php }?>
				...
				<?php if(!empty($item['payment_form'])){?>
					<a class="btn btn-default btn-xs pull-right mt-5 mr-5" href="<?php echo __SITE_URL;?>payments/save_bill_document/<?php echo $item['id_bill'];?>" title="Download payment form"><i class="ep-icon ep-icon_upload"></i> Payment form</a>
				<?php }?>
            </div>
