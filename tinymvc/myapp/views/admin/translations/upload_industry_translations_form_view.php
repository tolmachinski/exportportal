<div class="wr-modal-b">
   	<form class="modal-b__form validateModal" id="industry_translation_form" data-callback="industry_translations_callback">
...
<script>
industry_translations_callback = function() {
    var form = document.getElementById('industry_translation_form');
    ...
    xhr.open('POST', location.origin + '/translations/ajax_upload_industry_translation/<?php echo $upload_folder;?>', true);
