...
<div class="row">
	<div class="col-xs-12">
		<div class="titlehdr h-30">
			<span>Static text translations</span>
			<div class="dropdown pull-right">
				...
				<ul class="dropdown-menu" aria-labelledby="actionsMenuTranslations">
                    <?php if(have_right('manage_content')) { ?>
                        <li>
                            <a class="fancybox.ajax fancyboxValidateModalDT" href="<?php echo __SITE_URL;?>translations/popup_forms/add_file_translation_key_form" title="Add translation" data-title="Add translation" data-table="dtTranslationsList">
		...
		<?php tmvc::instance()->controller->view->display('admin/translations/translations_filter_panel'); ?>
...
<script type="application/javascript">
	...
	$(function(){
		dtTranslationsList = $('#dtTranslationsList').dataTable( {
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "<?php echo __SITE_URL?>translations/ajax_operations/translation_files_list_dt",
			"sServerMethod": "POST",
			"iDisplayLength": 100,
			"aoColumnDefs": [
