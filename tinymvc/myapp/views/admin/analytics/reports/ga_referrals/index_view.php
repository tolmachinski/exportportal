...
$(function(){
	analyticsDT = $('#analyticsDT').dataTable( {
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo __SITE_URL?>analytics/ajax_operations/google_referrals_dt",
		"sServerMethod": "POST",
		"aoColumnDefs": [
			...
			if(!analyticsFilter){
				analyticsFilter = $('.dt_filter').dtFilters('.dt_filter',{
					...
					onDelete: function(filterObj){
						...
						if(filterObj.name == 'referrer_source'){
							$ga_referrals.trigger("change");
						}
					},
					onReset: function(){
...
<div class="row">
	<div class="col-xs-12">
		<?php tmvc::instance()->controller->view->display('admin/analytics/reports/ga_referrals/filter_view')?>
		<div class="titlehdr">
			<span>Analytic report by referrals</span>
		</div>
		<div class="wr-filter-list clearfix mt-10"></div>
		<table class="data table-striped table-bordered w-100pr" id="analyticsDT" cellspacing="0" cellpadding="0" >
			 <thead>
				 <tr>
					 <th class="dt_target">Source</th>
