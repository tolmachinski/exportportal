<div class="wr-modal-b">
    <form method="post" action="<?php echo $action; ?>" class="validateModal modal-b__form" id="accreditation-documents--form">
        <div class="modal-b__content pb-0 w-700 mh-700 mt-10">
            <div class="row">
                <div class="form-group col-xs-12 mb-5">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <input type="text"
                            ...
                            value="<?php echo !empty($document['document_title']) ? $document['document_title'] : ''; ?>"
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <select name="category" class="form-control validate[required]" id="accreditation-documents--form-field--document-category">
                            ...
                            <?php foreach ($categories as list($category, $categoryLabel)) { ?>
                                <option
                                    value="<?php echo cleanOutput((string) $category); ?>"
                                    <?php echo $category === ($document['document_category'] ?? null) ? 'selected' : ''; ?>
                                >
                ...
                <div class="tab-content">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label cur-pointer"
                                            ...
                                            <input type="checkbox"
                                                ...
                                                data-select="groups"
                                                value="1"
                                                <?php if($groups_all) { echo 'checked'; } ?>>
                                            Select all
                                        </label>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label pull-left cur-pointer"
                                                    ...
                                                    <input type="checkbox"
                                                        ...
                                                        <?php echo checked($group['idgroup'], $groups_selected); ?>>
                                            ...
                                            <div class="form-check pull-right">
                                                <label class="form-check-label"
                                                    ...
                                                    <input type="checkbox"
                                                        ...
                                                        value="<?php echo $group['idgroup'];?>"
                                                        <?php echo checked($group['idgroup'], $groups_required_selected); ?>>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label cur-pointer" for="accreditation-documents--form-field--industries-all">
                                        <input type="checkbox"
                                            ...
                                            value="1"
                                            <?php if($industries_all) { echo 'checked'; } ?>>
                                        Select all
                                    </label>
                                </div>
                            </div>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label"
                                                ...
                                                <input type="checkbox"
                                                    ...
                                                    <?php echo checked($industry['category_id'], $industries_selected)?>>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="other-options">
                        <div class="row-fluid" style="height: 602px !important">
                            <div class="mt-20">
                                ...
                                <select name="company_types[]" class="form-control" id="accreditation-documents--form-field-company-types" multiple>
                                    ...
                                    <?php foreach ($company_types as $company_type) {?>
                                        <option value="<?php echo $company_type['id_type'];?>" <?php echo in_array($company_type['id_type'], $selected_company_types) ? 'selected' : '';?>><?php echo cleanOutput($company_type['name_type']);?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
        ...
        <div class="modal-b__btns clearfix">
            <input type="hidden" name="id_document" value="<?php echo $document['id_document'];?>">
