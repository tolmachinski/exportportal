<script>
    ...
    $(document).ready(function(){
        dtAccreditation = $('#dtAccreditation').dataTable( {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo __SITE_URL?>library_importer_exporter/ajax_dt_importer_exporter",
            "sServerMethod": "POST",
            "iDisplayLength": 50,
            "aoColumnDefs": [
                ...
                { "sClass": "w-150 tac", "aTargets": ['dt_phone'],      "mData": "dt_phone" },
...
var remove_acc_record = function(obj){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo __SITE_URL?>library_importer_exporter/ajax_library_operation/remove_record',
...
var download_last_excel = function(obj){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo __SITE_URL?>library_importer_exporter/ajax_library_operation/download_last_file',
        data: {},
        beforeSend: function(){ },
        dataType: 'json',
        success: function(data){
...
var visible_status = function(obj){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo __SITE_URL?>library_importer_exporter/ajax_library_operation/change_status',
...
var remove_list = function(obj){
    ...
    if (list.length > 0){
        $.ajax({
            type: 'POST',
            url: '<?php echo __SITE_URL?>library_importer_exporter/ajax_library_operation/remove_records',
            data: list,
            beforeSend: function(){ },
            dataType: 'json',
            success: function(data){
...
<div class="row">
    <div class="col-xs-12">
        <div class="titlehdr h-30">
            ...
            <a class="fancyboxValidateModalDT fancybox.ajax pull-right ep-icon ep-icon_upload mr-5" href="<?php echo __SITE_URL?>library_importer_exporter/popup_forms/add_record_excel" data-table="dtAccreditation" data-title="Add importer & exporter from file" title="Add importer & exporter from file"></a>
            <a class="fancyboxValidateModalDT fancybox.ajax pull-right ep-icon ep-icon_plus-circle txt-green mr-5" href="<?php echo __SITE_URL?>library_importer_exporter/popup_forms/add_record" data-table="dtAccreditation" data-title="Add new importer & exporter" title="Add importer & exporter manual"></a>
        </div>
