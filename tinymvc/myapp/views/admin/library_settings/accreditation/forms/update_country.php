    ...
    <div class="wr-form-content w-700 mh-600">
        <table cellspacing="0" cellpadding="0" class="data table-striped table-bordered w-100pr vam-table">
            <tbody>
                ...
                <tr>
                    <td class="w-40pr">
                        <input class="mmr-5" type="text" disabled value="<?php echo $record['country']; ?>" name="record_country">
                    </td>
                    <td class="w-40pr">
...
<script>
    function update_country(obj){
        ...
        if (selectCountry){
            $.ajax({
                type: 'POST',
                url: '<?php echo __SITE_URL ?>library_accreditation_body/ajax_library_operation/change_country_accreditation',
