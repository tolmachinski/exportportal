<form id="add-requirement-form" class="validateModal relative-b">
        ...
        <table cellspacing="0" cellpadding="0" class="data table-striped w-100pr vam-table">
            <tbody>
                ...
                <tr>
                    <td>Text</td>
                    <td>
                        <textarea class="w-100pr h-150 validate[required] requirement-text-block" name="text"></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
...
$(document).ready(function(){
    ...
    function modalFormCallBack(form, data_table){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo __SITE_URL ?>customs_requirements/ajax_requirement_operation/save_requirement',
            data: $form.serialize(),
            beforeSend: function () {
                showLoader($form);
            },
