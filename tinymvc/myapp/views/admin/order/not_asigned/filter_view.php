			...
			<tr>
				...
				<td>
					<div class="input-group">
						<input class="form-control dt_filter" type="text" data-title="Price from" name="price_from" id="price_from" placeholder="From" readonly>
						<div class="input-group-addon">-</div>
						<input class="form-control dt_filter" type="text" data-title="Price to" name="price_to" id="price_to" placeholder="To" readonly>
					</div>
				</td>
			</tr>
...
<script>
    $(document).ready(function() {
		$("#start_date, #finish_date, #price_from, #price_to").datepicker();
    });
</script>
