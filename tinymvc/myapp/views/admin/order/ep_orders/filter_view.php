	...
	<div class="filter-admin-panel" >
		...
		<table>
				...
				<td>
					<select class="dt_filter" data-title="Order status" name="order_status">
                        ...
                        <?php foreach ($orderStatuses as $orderStatus) {?>
						  <option data-value-text="<?php echo cleanOutput($orderStatus['status']);?>" value="<?php echo $orderStatus['id'];?>"><?php echo $orderStatus['status'];?></option>
                        <?php }?>
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class="input-group">
						<input class="form-control dt_filter datepicker" type="text" data-title="Start date from" name="start_date_from" placeholder="From" readonly>
						<div class="input-group-addon">-</div>
						<input class="form-control dt_filter datepicker" type="text" data-title="Start date to" name="start_date_to" placeholder="To" readonly>
					</div>
				</td>
			</tr>
			<tr>
