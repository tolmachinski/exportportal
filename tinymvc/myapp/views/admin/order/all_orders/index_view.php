...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        dtMyOrders = $('#dtMyOrders').dataTable( {
            ...
            "bServerSide": true,
            "searching": false,
            "sAjaxSource": "<?php echo __SITE_URL . 'order/ajax_admin_all_orders_dt';?>",
            "sServerMethod": "POST",
            "sorting": [[ 5, "desc" ]],
            "aoColumnDefs": [
                ...
                {"sClass": "w-50 tac vam", "aTargets": ['dt_manager'], "mData": "dt_manager", "bSortable": false}
            ],
...
<?php tmvc::instance()->controller->view->display('admin/order/all_orders/filter_view'); ?>

<div class="mt-10 wr-filter-list clearfix"></div>

<div class="row">
    <div class="ship col-xs-12" >
        <h3 class="titlehdr">All orders</h3>
        ...
        <table cellspacing="0" cellpadding="0" id="dtMyOrders" class="data table-bordered table-striped w-100pr">
            <thead>
                <tr>
                    ...
                    <th class="dt_manager">Manager</th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
