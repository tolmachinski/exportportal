...
<head>
	...
	<script src="<?php echo fileModificationTime('public/plug/icheck-2-0-0/js/icheck.min.js');?>"></script>
...
<div class="row flex-xl-nowrap">
		...
		<?php foreach($elements as $element){?>
			<?php foreach($element['elements'] as $element_key => $element_item){?>
				<div class="elements-view" id="<?php echo $element_item['id'];?>">
					...
					<?php views()->display('admin/epicons/blocks/'.$element_item['id']);?>
					...
					<?php if($element_item['show_code'] !== 'none'){
							...
							$code = file_get_contents('tinymvc/myapp/views/admin/epicons/blocks/'.$element_item['id'].$code_prefix.'.php');
						?>
	...
	<?php views()->display('admin/epicons/nav_elements');?>
</div>
</div>
</body>
</html>
