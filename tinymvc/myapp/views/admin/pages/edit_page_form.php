<div class="wr-modal-b">
    <form method="post" action="<?php echo $action; ?>" class="validateModal modal-b__form" id="pages--form">
        <input type="hidden" name="page" id="pages--form-field-page-id" value="<?php echo $page['id_page']; ?>">
        ...
        <div class="modal-b__content pb-0 w-750 mh-750 h-600 mt-10 pl-23 pr-23">
            <div class="form-group row mb-5">
                ...
                <div class="col-xs-12 col-sm-9">
                    <input type="text"
                        ...
                        value="<?php echo !empty($page['page_name']) ? cleanOutput($page['page_name']): ''; ?>"
            ...
            <div class="form-group row mb-5">
                ...
                <div class="col-xs-12 col-sm-9">
                    <input type="text"
                        ...
                        value="<?php echo !empty($page['page_controller']) ? cleanOutput($page['page_controller']): ''; ?>"
                        class="form-control validate[required,maxSize[250]]"
            ...
            <div class="form-group row mb-5">
                ...
                <div class="col-xs-12 col-sm-9">
                    <input type="text"
                        ...
                        value="<?php echo !empty($page['page_action']) ? cleanOutput($page['page_action']): ''; ?>"
                        class="form-control validate[required,maxSize[250]]"
            ...
            <div class="form-group row mb-5">
                ...
                <div class="col-xs-12 col-sm-9">
                    <input type="text"
                        ...
                        value="<?php echo !empty($page['page_url_template']) ? cleanOutput($page['page_url_template']): ''; ?>"
            ...
            <div class="form-group row mb-5">
                ...
                <div class="col-xs-12 col-sm-9">
                    <textarea id="pages--form-field--page-description"
                        name="description"
                        class="form-control validate[maxSize[500]]"
                        placeholder="Enter the page description"><?php echo !empty($page['page_description']) ? cleanOutput($page['page_description']) : ''; ?></textarea>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-9">
                    <select id="page--form-field--page-modules" name="modules[]" multiple>
                        ...
                        <?php foreach ($modules as $module) { ?>
                            <option value="<?php echo $module['id_module']; ?>" <?php echo $module['selected'] ? 'selected="selected"' : ''; ?>>
                                <?php echo cleanOutput($module['name_module']); ?>
                            </option>
                        <?php } ?>
                    </select>
                </div>
            ...
            <div class="form-group row mb-5">
                ...
                <div class="col-xs-12 col-sm-9" id="pages--form-field--page-file-views-wrapper">
                    <?php foreach ($page['page_view_files'] as $index => $view) { ?>
                        <div class="input-group mb-5">
                            <span class="input-group-addon">../views/</span>
                            <input type="text"
                                name="views[]"
                                id="pages--form-field--page-file-view-<?php echo $index + 1; ?>"
                                class="form-control validate[required,maxSize[1000]]"
                                value="<?php echo !empty($view) ? cleanOutput($view): ''; ?>"
