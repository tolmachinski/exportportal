<?php if(!empty($changes) && !empty($changes['old'])) { ?>
    <div class="row">
            ...
            <table cellspacing="0" cellpadding="0" class="data table-striped table-bordered table-fixed w-100pr mt-15 mb-15 vam-table" style="table-layout:fixed;">
                ...
                <tbody class="tabMessage">
                    <tr>
                        ...
                        <td class="w-80pr"><?php echo $changes['old']['logo_company']; ?></td>
                    </tr>
                    <tr>
                        <td class="w-20pr">Url</td>
                        <td class="w-80pr">
                            <a href="<?php echo ($url = getDisplayImageLink(array('{ID}' => $resource['id'], '{FILE_NAME}' => $changes['old']['logo_company']), 'companies.main')); ?>" target="_blank">
                                <?php echo $url; ?>
                            </a>
                        </td>
                    </tr>
