...
class Tinymvc_Library_Mobile_Detect
{
    /**
	...
	public function __construct(ContainerInterface $container)
	{
        $headers = null;
        $userAgent = null;
        if ($container->hasParameter('library.mobile_detection.headers')) {
            $headers = $container->getParameter('library.mobile_detection.headers') ?? null;
        }
        if ($container->hasParameter('library.mobile_detection.user_agent')) {
            $userAgent = $container->getParameter('library.mobile_detection.user_agent') ?? null;
        }
