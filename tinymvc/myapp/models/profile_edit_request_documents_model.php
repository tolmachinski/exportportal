...
/**
 * Profile_Edit_Request_Documents model.
 */
final class Profile_Edit_Request_Documents_Model extends Model
{
    /**
     ...
     * {@inheritdoc}
     */
    protected string $table = 'profile_edit_request_documents';

    /**
     * {@inheritdoc}
     */
    protected string $alias = 'PROFILE_EDIT_REQUEST_DOCUMENTS';
    ...
    {
        return $this->belongsTo(Profile_Edit_Requests_Model::class, 'id_request')->enableNativeCast();
    }
...
// End of file profile_edit_request_documents_model.php
// Location: /tinymvc/myapp/models/profile_edit_request_documents_model.php
