...
use App\Common\Contracts\Order\ProductOrderState;
use App\Common\Database\AttributeCastInterface;
use App\Common\Database\Model;
use Doctrine\DBAL\Platforms\AbstractPlatform;

class ProductOrderStateCast implements AttributeCastInterface
{
    /**
     * {@inheritdoc}
     */
    public function get(AbstractPlatform $platform, Model $model, string $key, $value, array $attributes = [])
    {
        ...
        return ProductOrderState::tryFrom($value);
    }
    ...
    {
        if (!$value instanceof ProductOrderState) {
            return null;
        }
