...
final class DueDateBadge extends Badge
{
    /**
     * The current user ID.
     */
    ...
    {
        // Fail if current user is sender or envelope is not active or due date is null
        ...
        return
            ...
            && null !== $currentRecipient['due_date']
            && (RecipientTypes::SIGNER === $currentRecipient['type'] || RecipientTypes::VIEWER === $currentRecipient['type'])
