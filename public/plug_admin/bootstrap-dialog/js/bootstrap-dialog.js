...
(function(root, factory) {
    ...
    BootstrapDialog.DEFAULT_TEXTS['PAYMENT'] = 'Yes, continue payment';
    ...
    BootstrapDialog.showScrollbar = function() {
        ...
        if (lastDialogInstance !== null && lastDialogInstance.isRealized() && lastDialogInstance.isOpened()) {
            ...
            bsModal._checkScrollbar();
            $('body').addClass('modal-open');
            bsModal._setScrollbar();
        }
    };
    ...
    BootstrapDialog.prototype = {
        ...
        createCloseButton: function() {
            ...
            var $icon = $('<a class="close"><i class="ep-icon ep-icon_remove-stroke"></i></a>');
