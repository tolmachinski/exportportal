var CompanyEditRequestDashboardModule = (function () {
    "use strict";
    ...
    var defaultDatagridOptions = {
        ...
        aoColumnDefs: [
            ...
            { sClass: "w-300 vam", aTargets: ["dt-company"], mData: "company", bSortable: false },
    ...
    function entrypoint(params) {
        ...
        $(globalThis).on('preview-company-edit-request::accepted', onAcceptOrDeline.bind(undefined, tableHandler.api));
        $(globalThis).on('preview-company-edit-request::declined', onAcceptOrDeline.bind(undefined, tableHandler.api));
    }
