...
!function ($) {
	...
	var TabDrop = function (element, options) {
		...
		if (options.align === "left")
			this.dropdown = $('<li class="dropdown hide pull-left tabdrop"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="display-tab"></span></a><ul class="dropdown-menu dropdown-menu-right"></ul></li>');
		else
			this.dropdown = $('<li class="dropdown hide pull-right tabdrop"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="display-tab"></span></a><ul class="dropdown-menu dropdown-menu-right"></ul></li>');
