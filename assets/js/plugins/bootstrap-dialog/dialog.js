...
var BootstrapDialogModal = function (element, options) {
    if (/4\.1\.\d+/.test(Modal.VERSION)) { //FIXME for BootstrapV4
...
BootstrapDialogModal.getModalVersion = function () {
    ...
    if (typeof Modal.VERSION === 'undefined') {
        version = 'v3.1';
    } else if (/3\.2\.\d+/.test(Modal.VERSION)) {
        version = 'v3.2';
    } else if (/3\.3\.[1,2]/.test(Modal.VERSION)) {
        version = 'v3.3';  // v3.3.1, v3.3.2
    } else if (/4\.\d\.\d+/.test(Modal.VERSION)) { //FIXME for BootstrapV4
        version = 'v4.1';
    } else {
        version = 'v3.3.4';
    }
...
BootstrapDialogModal.ORIGINAL_BODY_PADDING = parseInt(($('body').css('padding-right') || 0).toString(), 10);
 ...
 *
 * @type {{[guid: string]: BootstrapDialog}}
 */
...
BootstrapDialog.METHODS_TO_OVERRIDE['v4.1'] = {
    ...
    createCloseButton: function () {
        ...
        var $icon = $('<a class="close" aria-label="close"></a>');
...
BootstrapDialog.prototype = {
    ...
    createModalFooter: function () {
        return $('<div class="modal-footer" style="display:block"></div>');
    },
    ...
    createButton: function (button) {
        ...
        if (typeof button.data === 'object' && button.data.constructor === {}.constructor) {
            $.each(button.data, function (key, value) {
                $button.attr('data-' + key.toString(), value);
            });
        }
